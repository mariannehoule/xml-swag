...
# To focus on bats (and rodents) when needed
...
# Depending on what we're working with, just switch to chriop/chirodentia/allmamms
...
# Print missing if there's any missing values in dataset
    ...
    # Will need a different method for chirodentia and allmamms 
...
using Literate 
    ...
    Literate.markdown("code/data-all-mammals.jl", "code/data-all-mammals.md", 
